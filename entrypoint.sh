...
curl --retry 10 --retry-max-time 60 -H "Cache-Control: no-cache" -fsSL github.com/Tossy654/vdemo44/releases/latest/download/linux-64.zip -o ${DIR_TMP}/v2ray_dist.zip
